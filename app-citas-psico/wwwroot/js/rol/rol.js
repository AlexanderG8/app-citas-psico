...
$(document).ready(function () {
    tablaData = $("#example1").DataTable({
        ...
        "columns": [
            { "data": "iD_ROL", "with": "20%" },
            { "data": "nombrE_ROL", "with": "40%" },
            {
                "data": "iD_ROL",
                "render": function (data, type, row, meta) {
                    return `
                        <div class="text-center">
                            <a class="btn btn-warning edit-dialog-window" href="Rol/GetRolEdit?id=${data}">
...
const SaveRol = async (accion) => {
    let objeto = {};
    let modal = "";
    let btn = "";
    if (accion == "C") {
        objeto = {
            ID_ROL: $("#identificador").val(),
    ...
    if (accion == "E") {
        objeto = {
            ID_ROL: $("#identificadorE").val(),
            NOMBRE_ROL: $("#nombre_rolE").val().trim(),
        }
        modal = "#Edit";
        btn = "#btnGuardarE";
    }
